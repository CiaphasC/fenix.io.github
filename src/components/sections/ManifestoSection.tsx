  ...
  return (
    <section id="manifiesto" className="relative z-10 border-t border-gray-100 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="relative h-[460px] sm:h-[560px] lg:h-auto bg-gray-100 overflow-hidden group">
          ...
          <div className="absolute bottom-8 left-6 right-6 sm:bottom-12 sm:left-12 sm:right-auto z-20 max-w-md">
        ...
        <div className="py-16 sm:py-24 px-6 sm:px-12 lg:px-24 flex flex-col justify-center bg-white">
          <Reveal direction="y">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif mb-10 sm:mb-12 text-gray-900">
              Resiliencia <br />
              <span className="text-[#A08870] italic">Operativa</span>.
            </h2>
          </Reveal>

          <div className="space-y-8 text-gray-600 font-light text-base sm:text-lg leading-relaxed">
            <Reveal delay={0.1}>
              <p>
            ...
            <Reveal delay={0.3}>
              <div className="pt-8 border-t border-gray-100 mt-8">
                <div className="flex items-center gap-4 text-gray-900 mb-2">
                  ...
                  <span className="font-serif text-lg sm:text-xl">1 Año 7 Meses</span>
                </div>
